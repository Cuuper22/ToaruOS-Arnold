...
# Move mouse to visible area
QCmd "mouse_move 400 300"
Start-Sleep -Seconds 1

# Screenshot with cursor
Remove-Item "$BUILD\ss_cursor.ppm" -ErrorAction SilentlyContinue
QCmd "screendump $BUILD\ss_cursor.ppm"
Start-Sleep -Seconds 1
Write-Host "Cursor: $((Get-Item "$BUILD\ss_cursor.ppm" -ErrorAction SilentlyContinue).Length) bytes"
